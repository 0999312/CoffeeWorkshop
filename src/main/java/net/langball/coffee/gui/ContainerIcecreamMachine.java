...
public class ContainerIcecreamMachine extends Container
{
    ...
    public ContainerIcecreamMachine(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotMachineICE(furnaceInventory, 1, 112, 17));
        this.addSlotToContainer(new SlotICEMachineOutput(playerInventory.player, furnaceInventory, 2, 83, 57));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0)
            {
                ...
                else if (TileEntityIcecreamMachine.isItemFuel(itemstack1))
                {
