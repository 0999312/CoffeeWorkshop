...
public class SlotRollerOutput extends Slot {
	 /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer player;
    private int removeCount;

    public SlotRollerOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.player.world.isRemote)
        {
            ...
            float f = RollerRecipes.instance().getSmeltingExperience(stack);
