...
public class SlotICEMachineOutput extends Slot {
	  private final EntityPlayer player;
	    ...
	    public SlotICEMachineOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
	    {
	    ...
	    protected void onCrafting(ItemStack stack)
	    {
	        ...
	        if (!this.player.world.isRemote)
	        {
	            ...
	            float f = IcecreamMachineRecipes.instance().getSmeltingExperience(stack);
