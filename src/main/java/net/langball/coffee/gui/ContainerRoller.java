...
public class ContainerRoller extends Container
{
    ...
    public ContainerRoller(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new SlotRollerOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0)
            {
                ...
                else if (TileEntityRoller.isItemFuel(itemstack1))
                {
