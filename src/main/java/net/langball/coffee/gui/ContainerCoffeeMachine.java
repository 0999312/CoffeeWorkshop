...
public class ContainerCoffeeMachine extends Container
{
    ...
    public ContainerCoffeeMachine(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 36, 35));
        this.addSlotToContainer(new SlotCoffeeMachineOutput(playerInventory.player, furnaceInventory,1, 116, 35));
