...
public class CategoryRoller extends BlankRecipeCategory<IRecipeWrapper>{
	 protected final IDrawable background;
	  private final IDrawable icon;
	  public CategoryRoller(IGuiHelper helper) {
		  ResourceLocation backgroundTexture = new ResourceLocation(CoffeeWork.MODID+":textures/gui/roller.png");
		  this.icon = helper.createDrawableIngredient(new ItemStack(BlockLoader.Roller));
	...
	public String getTitle() {
		// TODO Auto-generated method stub
		return I18n.format("jei.coffeework.category.roller", new Object[0]);
	}

	@Override
	public String getUid() {
		// TODO Auto-generated method stub
		return "coffeework.roller";
	}
	@Override
