...
import net.langball.coffee.block.BlockClayOven;
...
public class TileEntityOven extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockClayOven.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = OvenRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = OvenRecipes.instance().getSmeltingResult(itemstack);
    ...
    {
        return CoffeeWork.MODID+":oven_clay";
    }
