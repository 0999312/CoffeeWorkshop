...
public class VillagerCoffee {
	public static void registerVillager() {
		...
		career.addTrade(1, new SimpleBuy(new ItemStack(ItemLoader.materials,4,2),new PriceInfo(6, 11)));
		...
		career.addTrade(3, new SimpleBuy(new ItemStack(ItemLoader.materials,16,7),new PriceInfo(2, 6)));
		career.addTrade(3, new SimpleSell(new ItemStack(ItemLoader.materials,8,2),new PriceInfo(2, 6)));
	}
